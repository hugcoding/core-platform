...
FIELDS = ["file_id", "content_group_id", "path", "filename", "extension", "size_bytes",
          ...
          "proposal_confidence", "proposal_evidence", "path_reduction_reason_codes", "collision_status", "contract_version", "contract_checksum",
...
def main(argv=None) -> int:
    ...
    csv_rows = [{
        **row,
        "proposal_evidence": json.dumps(row["proposal_evidence"], ensure_ascii=False),
        "path_reduction_reason_codes": json.dumps(row["path_reduction_reason_codes"]),
    } for row in rows]
