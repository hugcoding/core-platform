...
DROP VIEW IF EXISTS public.v_latest_workset_ai_proposal;
ALTER TABLE public.document_review_events DROP COLUMN IF EXISTS ai_proposal_id;
DROP TABLE IF EXISTS public.workset_ai_proposals;
DROP TABLE IF EXISTS public.workset_ai_runs;
