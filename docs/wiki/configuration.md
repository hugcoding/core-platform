...
CORE schrijft CSV-exports standaard als UTF-8 met BOM en gebruikt een
puntkomma (`;`) als veldscheidingsteken. Daardoor openen Nederlandse
Excel-installaties de kolommen en tekens direct correct. Invoercommando's
blijven oudere komma-gescheiden CORE-manifesten automatisch herkennen.
