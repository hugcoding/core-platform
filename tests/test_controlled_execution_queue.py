...
class ControlledExecutionQueueTests(unittest.TestCase):
    ...
    def test_workset_exposes_bounded_human_approval_ui(self):
        ...
        self.assertIn("data-reinventory-file", script)
        self.assertIn("start_candidate_reinventory", app)
        self.assertIn('"observed_size_bytes": item.get("observed_size_bytes")', app)
